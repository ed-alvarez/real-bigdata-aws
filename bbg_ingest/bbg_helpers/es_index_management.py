...
if __name__ == "__main__":
    from bbg_ingest import bbg_settings
    from bbg_ingest.bbg_helpers.es_bbg_msg_index import BBG_MSG
    ...
    es_index_manage.templateName = "bbg-parse-msg-v4"
    es_index_manage.indexPattern = "bbg-parse-msg-v4-*"
    es_index_manage.dataInputAlias = bbg_settings.MSG_ES_INPUT_ALIAS
    es_index_manage.setup()
