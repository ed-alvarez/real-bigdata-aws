...
class manageESIndex:
    ...
    def create_and_migrate(self, _index_id=1):
        ...
        if self._move_data:
            ...
            self._es.reindex(
                body={
                    "source": {"index": _previous_index},
                    "dest": {"index": _next_index},
                },
...
if __name__ == "__main__":
    ...
    # Get ES credentials direct from AWS Parameter Store
    ...
    es_index_manage.dslDocument = es_slack_index.SlackDocument
    es_index_manage.templateName = "slack-parse-v1"
    es_index_manage.indexPattern = "slack-parse-v1-*"
    es_index_manage.dataInputAlias = es_slack_index.DataInput.alias
